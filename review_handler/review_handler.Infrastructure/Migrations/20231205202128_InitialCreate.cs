        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CastRating = table.Column<int>(type: "int", nullable: true),
                    DirectorRating = table.Column<int>(type: "int", nullable: true),
                    GenreRating = table.Column<int>(type: "int", nullable: true),
                    SciptRating = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FilmographyId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ActorMovie", x => new { x.CastId, x.FilmographyId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ActorMovie_Movies_FilmographyId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ActorMovie_FilmographyId",
                table: "ActorMovie",
